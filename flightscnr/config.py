...
DISPLAY_ROUND = _bool(os.environ.get("DISPLAY_ROUND", "True" if DISPLAY_WIDTH == DISPLAY_HEIGHT else "False"))
...
def square_framebuffer_side() -> int:
    ...
    if DISPLAY_ROUND:
        logger.warning(
            "DISPLAY_WIDTH (%d) != DISPLAY_HEIGHT (%d) but DISPLAY_ROUND is True. Set both to your panel resolution "
