...
requirements = python3,pygame,requests,urllib3,certifi,idna,charset-normalizer,qrcode,pillow,websockets,python-dotenv,flask,jinja2,click,werkzeug,itsdangerous,blinker,xyzservices,branca,folium,protobuf,grpcio,fr24
